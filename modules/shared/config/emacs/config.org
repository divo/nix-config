...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Steven"
    user-mail-address "steven@nory.ai")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/stevendiviney/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/stevendiviney/bin" "/profile/bin" "/Users/stevendiviney/.npm-packages/bin" "/Users/stevendiviney/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
